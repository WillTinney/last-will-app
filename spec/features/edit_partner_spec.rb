...
feature 'Partner Edit Page', js: false do
  ...
  before do
    ...
    visit "/users/#{user.id}/assignees/#{@partner.id}/edit"
  end
  ...
  scenario 'user can edit partner details' do
  ...
  scenario 'user can upload a profile picture of partner' do
